...
exports.saveAddressToBolt = function (order) {
    try {
        ...
        var addressUrl = shippingAddress.custom.boltAddressId && !empty(shippingAddress.custom.boltAddressId) ? (constants.SHOPPER_ADDRESS_URL + '/' + shippingAddress.custom.boltAddressId) : constants.SHOPPER_ADDRESS_URL;
